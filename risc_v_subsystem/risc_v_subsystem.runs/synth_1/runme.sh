...
HD_PWD='C:/git/tristan/risc_v_subsystem/risc_v_subsystem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tristan_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tristan_top.tcl
