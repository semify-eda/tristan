...
HD_PWD='C:/git/tristan/risc_v_subsystem/risc_v_subsystem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tristan_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tristan_top.tcl -notrace
