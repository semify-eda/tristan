...
// bitstreams for the uncompressed signals after alligning the bits
// needs less computations than read every signal alone. all signals
// are read at once and stored in this bitsreams
...
uint8_t store_in_not_byte_alligned_output(bitstream* b_stream, uint8_t number_of_bits,
